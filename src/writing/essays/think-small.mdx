...
I think the main reason for that is <Link href="/slippery-scope">_slippery scope_</Link>. In other words, thinking too big. There are times for thinking big, of course (e.g. [Bun](https://bun.sh/)), but for single-weekend side projects I am trying to think smaller these days.
...
This essay is as much for myself—as a reminder and to set an intention—as it is for an audience, which is generally true about most things I write. As I said up top (and in my note on <Link href="/silly-tlds">silly TLDs</Link>), I’ve often fallen into the trap of buying domain names on a whim and leaving projects unfinished.
