...
[neal.fun](https://neal.fun) is the king of small, fun projects. I like [Draw Logos From Memory](https://neal.fun/logos-from-memory/).
...
Small, useful things are not only more likely for you/me the developer to actually ship, but they are also more likely for people to try. If someone can understand something quickly, they will be more likely to give it a shot, I think.

[zany.sh](https://zany.sh/) is a good example of that. You can understand it immediately, _and_ you can play with it immediately. Copy-paste the testing URL in your address bar then update the text/color/font params, and you have a decent custom favicon.
