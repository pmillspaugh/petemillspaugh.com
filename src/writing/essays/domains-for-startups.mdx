...
<Callout>
  I gave a conference talk on this topic at StartupCincy Week. My talk website,
  which covers the same ground as this essay, is here:
  [dotcom.press/cincy](https://dotcom.press/cincy)
</Callout>
...
ccTLDs that are strongly associated with a country (e.g., `.de` in Germany) will be considered more relevant in search results in that region, but [Google treats many ccTLDs as generic](https://developers.google.com/search/docs/specialty/international/managing-multi-regional-sites?visit_id=638958016931825172-2007749418&rd=1#generic-domains), like `.ai`, `.co`, and `.io`.
