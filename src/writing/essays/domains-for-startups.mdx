...
At this point, if you firmly subscribe to the need-the-dot-com school of thought, [buying alternatives](#buying-an-alternative-tld) could still be a good idea for defensive (read: security) or operational purposes. And likewise if you’re in the non-dot-com camp, you should still go through the exercise of searching for a dot com. You can own both and redirect one (e.g., vercel.dev redirects to vercel.com; valtown.com redirects to val.town).
...
3. Made up, obscure, or non-English words. For example, I just brainstormed for one minute and came up with [remath.com](https://instantdomainsearch.com/?q=remath), currently asking $2k aftermarket. There are also names where a startup-y suffix becomes part of the name itself, like Spotify.
...
As of September 2025, there are [1,592 top-level domains](https://dotcom.press/archive/1592-tlds). That means there are 1,591 dot com alternatives, although some are restricted—they don’t give a `.gov` to just anyone. You have something like a thousand actual choices.
