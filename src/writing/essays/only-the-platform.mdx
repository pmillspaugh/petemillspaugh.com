...
There are a lot of _#usetheplatform_ advocates out there _(read: Twitter)_. [Syntax.fm](https://syntax.fm/—my favorite web dev podcast—has a couple fun, relevant episodes:
