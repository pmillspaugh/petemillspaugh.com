...
Even crazier is the list of language features first introduced in Lisp. PG lists nine features introduced by Lisp, including:
...
The first mention of JavaScript in the book comes on page 196 when discussing lexical scope and closures. That chapter is [_Revenge of the Nerds_](https://www.paulgraham.com/icad.html), which PG originally published in 2002.
