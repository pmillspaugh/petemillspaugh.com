...
I wrote a [Val for email subscription signup](https://www.val.town/v/petermillspaugh/emailSubscription)—feel free to fork and remix if you’d like! I’ll explain a few things below, but if you want to jump to demo + code, the signup is in the footer and the code is just below this paragraph. You can also view the [README](https://www.val.town/v/petermillspaugh/emailSubscription).
...
And here’s a simplified example of a confirmation page. Again, my full implementation is [here](https://github.com/pmillspaugh/petemillspaugh.com/blob/main/src/components/EmailConfirmation/.EmailConfirmation.tsx).
