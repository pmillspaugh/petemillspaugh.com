...
I went with Val Town, but if I ever want to turn to a more feature-rich solution, I’d probably use Buttondown. If you want to see it in action, [Robin Rendle](https://robinrendle.com/), [swyx](https://www.swyx.io/), [cassidoo](https://cassidoo.co/), and [browsertech](https://digest.browsertech.com/) all use it for their newsletters. It has off-the-shelf email verification, you can write emails in markdown, plus there’s a bunch of other stuff like analytics and monetization (which I don’t have any plans for, btw).
