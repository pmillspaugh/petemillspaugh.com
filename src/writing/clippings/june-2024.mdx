...
I started exploring [Membrane](https://www.membrane.io/), building small programs like the <Link href="/membrane-feedback-form">feedback form</Link> in my garden and a [solar eclipse countdown](https://x.com/pete_millspaugh/status/1775331254096822565). Then a couple months later I joined Membrane!
...
I started <Link href="/hello-rust">learning Rust</Link>, which I was already interested in and now have a convenient reason to learn. I plan to <Link href="/should-i-learn-computer-science">accidentally learn some Computer Science</Link> along the way.
...
So I’m starting to accrue perspective on working in software while living outside a tech hub. There aren’t weekly meetups like you have in NYC and SF, ofc, but there are engineers around if you look closely! And you can start your own meetups (something I’d like to do soon). I'll also fly into NYC every couple months to go to a meetup and catch up with friends. Plus, I'm just leaning more into making online connections (e.g. FoC book club). I’ll also try to attend at least a couple conferences per year.
