...
This is the first clipping from my digital garden. I’m still thinking through what I want these to be, but my rough idea for clippings is an email newsletter that I send every month or two (ish) with a selection of stuff I’ve written since the last clipping, plus interesting things I’ve read or anything else on my mind. I planted a note riffing on <Link href="/newsletters" target="_blank">what I want clippings to be</Link>, if you’re curious.
