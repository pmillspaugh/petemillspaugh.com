...
Credit <a href="https://www.radix-ui.com/primitives/docs/components/select" target="_blank">Radix UI docs</a> for the find. `unset` is widely supported by modern browsers: <a href="https://caniuse.com/?search=unset" target="_blank">caniuse.com/?search=unset</a>
