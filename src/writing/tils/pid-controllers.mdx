...
I’d never heard of PIDs before reading Azeem’s post. As I understand it, PID controllers are used to continuously adjust some process variable in a system to meet a target. I think an example makes it more clear.
