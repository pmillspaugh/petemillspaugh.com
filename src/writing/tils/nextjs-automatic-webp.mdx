...
The `<Image>` component from Next.js automatically converts PNG images to <a href="https://web.dev/learn/images/webp/" target="_blank">WebP</a>. From the <a href="https://nextjs.org/docs/app/building-your-application/optimizing/images" target="_blank">Image Optimization docs</a>:
