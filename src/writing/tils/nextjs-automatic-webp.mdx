...
While updating this website's design, I created an SVG footer illustration to replace the PNG image I was using before. Out of curiosity, I checked how large the PNG file was both locally and in DevTools → Network. It was a 34KB `.png` file locally and a ~29KB `.webp` file over the network. Interestingly, the file size is further optimized based on how much of the image is visible in the viewport: ~14KB on mobile up to ~29KB on desktop.
