...
I wanted to build a website without a web framework as a learning exercise to play with native browser stuff.
Then I took it a step further and asked what it'd be like to build a website without any external dependencies whatsoever.
No open-source code, no vendor code. Yada, yada, yada.
